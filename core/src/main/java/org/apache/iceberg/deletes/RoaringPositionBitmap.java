...
public class RoaringPositionBitmap {
   ...
   * into a collection. Useful for large bitmaps in testing and tooling scenarios.
   *
   * <p>The iterator respects the natural ordering of positions (sorted ascending).
   *
  ...
  public java.util.Iterator<Long> iterator() {
    return new java.util.Iterator<Long>() {
      ...
      public Long next() {
        ...
        int key = currentKey - 1; // currentKey was already incremented
