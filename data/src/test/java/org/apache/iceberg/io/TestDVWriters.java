...
public abstract class TestDVWriters<T> extends WriterTestBase<T> {
  ...
  public void testBasicDVs() throws IOException {
    ...
    // init the DV writer
    BitmapDeleteWriter dvWriter =
        new BitmapDeleteWriter(fileFactory, new PreviousDeleteLoader(table, ImmutableMap.of()));
  ...
  public void testRewriteDVs() throws IOException {
    ...
    BitmapDeleteWriter dvWriter2 =
        new BitmapDeleteWriter(
            fileFactory,
